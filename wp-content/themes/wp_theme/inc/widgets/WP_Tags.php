<?php
class WP_Tags extends WP_Widget {
    /**
	...
	public function __construct() {
		parent::__construct(
			...
			'WP_Tags', // Name
			[
                'description' => __('Widget hiển thị thẻ','wp_theme')
            ]
		);
	}
	/**
	...
	public function widget( $args, $instance ) {
        ...
        ob_start();
        $args = [
            'taxonomy' => 'post_tag', // các thẻ tag
            'hide_empty' => false, //hiển thị tất cả, ví dụ true ẩn bài viết rỗng
        ];
